        ...
        <div>
            <Menu inverted>
                <Container>
                    ...
                    <Menu.Item as="a">Haberler</Menu.Item>

                    <Dropdown item simple text="Eğitim">
                        <Dropdown.Menu>
                    ...
                    <Menu.Item as="a">Projeler</Menu.Item>
                    <Menu.Item as="a">Organizasyonlar</Menu.Item>
                    <Menu.Item as="a">Sponsorlar</Menu.Item>
                    <Menu.Item as="a">İstatistikler</Menu.Item>
